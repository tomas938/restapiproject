<template>
	<div class="root">
		...
		<div
			:class="{ white: theme }"
			v-if="mounted && !africa && !america && !asia && !europe && !oceania"
		>
			<ul class="grid">
				<li
					:class="{ white: theme }"
		...
		<div :class="{ white: theme }" v-if="africa">
			<ul class="grid">
				<li
					:class="{ white: theme }"
		...
		<div :class="{ white: theme }" v-if="america">
			<ul class="grid">
				<li
					:class="{ white: theme }"
		...
		<div :class="{ white: theme }" v-if="asia">
			<ul class="grid">
				<li
					:class="{ white: theme }"
		...
		<div :class="{ white: theme }" v-if="europe">
			<ul class="grid ">
				<li
					:class="{ white: theme }"
		...
		<div :class="{ white: theme }" v-if="oceania">
			<ul class="grid">
				<li
					:class="{ white: theme }"
...
export default {
	...
	mounted() {
		this.res = fetch("https://restcountries.eu/rest/v2/all");
		this.countries = this.res.json();
	...
	methods: {
		...
		// this.searchedCountry = this.inputedcountry =
		// checkCountry() {
		// 	this.searchedCountry = this.inputedcountry = this.countries.filter(
		// 		(country) =>
		// 			country.name.toLowerCase() === this.searchedCountry.toLowerCase()
		// 	);
		// 	// this.inputedcountry = "";
